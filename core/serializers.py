...
class SuggestionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Suggestion
        fields = ['id', 'title', 'image', 'description', 'author_name', 'author_id', 'author_email', 'status', 'created_at', 'updated_at', 'comments', 'board', 'votes']
        read_only_fields  = ['created_at', 'updated_at']

class CommentSerializer(serializers.ModelSerializer):
    class Meta:
        model = Comment
        fields = ['id', 'body', 'author_name', 'author_id', 'author_email', 'suggestion', 'created_at']
